      ...
      body: ListView(
        ...
        children: [
          ...
          _buildFeatureCard(
            ...
            description: 'Create, Read, Update, Delete operations with generated repositories',
          ...
          _buildFeatureCard(
            ...
            description: 'Transactions, migrations, foreign keys, and complex queries',
            icon: Icons.code,
            color: Colors.purple,
            onTap: () => Navigator.push(
              context,
          ...
          _buildFeatureCard(
            ...
            description: 'Use native SQLite API directly without code generation',
            icon: Icons.api,
            color: Colors.orange,
            onTap: () => Navigator.push(
              context,
          ...
          _buildFeatureCard(
            ...
            onTap: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (_) => const NativeIntegrationScreen()),
            ),
          ),
          const SizedBox(height: 16),
          _buildFeatureCard(
            ...
            description: 'View database info, table counts, and performance metrics',
